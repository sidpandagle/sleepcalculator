...
export const metadata: Metadata = {
  ...
  description:
    "Sleep Schedule is a free sleep calculator built on peer-reviewed sleep cycle research and CDC sleep duration guidelines.",
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <section className="mb-10">
        ...
        <p className="text-slate-400 leading-relaxed mb-3">
          Sleep Schedule was built by a software developer with a long-standing interest in sleep science — because most sleep tools out there are inaccurate, ad-heavy, or ignore the underlying biology of sleep cycles.
        </p>
