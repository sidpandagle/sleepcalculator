...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-slate-500 text-sm mb-10">Last updated: June 27, 2026</p>
      ...
      <div className="space-y-10 text-slate-400 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-white mb-3">3. Not medical advice</h2>
          <p className="mb-3">All content and tools on this Site are provided for <strong className="text-white">general informational purposes only</strong>. Nothing on this Site constitutes medical advice, diagnosis, or treatment. The calculators use population-level averages from published health authority guidelines (CDC, AAP, AASM, ACOG, NSF).</p>
        ...
        <section>
          ...
          <p>We make reasonable efforts to keep the information current and accurate. However, sleep science research evolves, and guidelines may be updated. We do not warrant that any information on the Site is complete, accurate, or up to date. The Site may contain errors — if you find one, please use the <a href="/contact" className="text-indigo-400 hover:text-indigo-300 transition-colors">contact form</a>.</p>
        </section>
        ...
        <section>
          ...
          <p>Use of the Site is governed by our <a href="/privacy" className="text-indigo-400 hover:text-indigo-300 transition-colors">Privacy Policy</a>, which is incorporated into these Terms by reference.</p>
        </section>
        ...
        <section>
          ...
          <p>For questions about these Terms, use the <a href="/contact" className="text-indigo-400 hover:text-indigo-300 transition-colors">contact form</a>.</p>
        </section>
      </div>
    </div>
  );
