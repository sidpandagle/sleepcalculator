...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticUrls: MetadataRoute.Sitemap = [
    { url: "https://sleepschedule.in",                            lastModified: new Date(), changeFrequency: "weekly",  priority: 1   },
    { url: "https://sleepschedule.in/blog",                       lastModified: new Date(), changeFrequency: "weekly",  priority: 0.8 },
    { url: "https://sleepschedule.in/nap-calculator",             lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: "https://sleepschedule.in/sleep-duration-calculator",  lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: "https://sleepschedule.in/sleep-debt-calculator",      lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: "https://sleepschedule.in/rem-sleep-calculator",       lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: "https://sleepschedule.in/pregnancy-sleep-calculator", lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: "https://sleepschedule.in/baby-sleep-calculator",      lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  ];
