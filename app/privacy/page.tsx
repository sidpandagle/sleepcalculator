...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      <h1 className="font-serif font-normal text-4xl text-linen mb-2">Privacy Policy</h1>
      <p className="text-mist text-sm mb-10">Last updated: June 24, 2026</p>

      <div className="prose prose-invert prose-slate max-w-none space-y-8 text-mist leading-relaxed">
        <section>
          <h2 className="font-serif font-normal text-2xl text-linen mb-3">1. Who We Are</h2>
          <p>
            Sleep Schedule (<strong>sleepschedule.in</strong>) is a free sleep cycle tool. You can reach us at{" "}
            <a href="mailto:siddhant.pandagle1998@gmail.com" className="text-ember hover:text-ember-light">
        ...
        <section>
          <h2 className="font-serif font-normal text-2xl text-linen mb-3">2. What Data We Collect</h2>
          ...
          <ul className="list-disc list-inside mt-3 space-y-2 text-mist">
            <li>
              <strong className="text-mist">Google Analytics 4 (GA4)</strong> — collects anonymised usage data (pages visited, session duration, device type, approximate location). This is only activated after you accept cookies.
            </li>
            <li>
              <strong className="text-mist">Vercel Analytics</strong> — privacy-friendly, aggregated traffic metrics with no cookies.
            </li>
          </ul>
        </section>

        <section>
          <h2 className="font-serif font-normal text-2xl text-linen mb-3">3. Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif font-normal text-2xl text-linen mb-3">4. How We Use Data</h2>
        ...
        <section>
          <h2 className="font-serif font-normal text-2xl text-linen mb-3">5. Data Retention</h2>
          <p>GA4 retains event data for 14 months by default. Vercel Analytics data is aggregated and not tied to individuals.</p>
        </section>

        <section>
          <h2 className="font-serif font-normal text-2xl text-linen mb-3">6. Your Rights</h2>
          <p>
        ...
        <section>
          <h2 className="font-serif font-normal text-2xl text-linen mb-3">7. Third-Party Links</h2>
          <p>The blog may link to external websites. We are not responsible for their privacy practices.</p>
        </section>

        <section>
          <h2 className="font-serif font-normal text-2xl text-linen mb-3">8. Changes to This Policy</h2>
